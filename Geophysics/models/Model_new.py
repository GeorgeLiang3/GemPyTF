...
class Model(object):
    def __init__(
        ...
        # define density
        self.geo_data.add_surface_values([2.6, 3.5, 2.0])
        ...
        section_dict = {'section1': ([0, 500], [1000, 500], [50, 50])}
...
###########
    ...
    def create_tensorflow_graph(self, input, gradient = False):
        self.TFG = TFGraph(input, self.fault_drift,
                ...
                self.C_o, self.rescale_factor,slope = 1, dtype = self.tfdtype, gradient = gradient)
