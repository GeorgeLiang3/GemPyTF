...
class Stat(object):
    ...
    # def set_prior(self,mean,cov_prior,Number_para = 70,norm = None,monitor = True):
    #     '''
    #        Input is rescaled mean and std
    #     '''
    ...
    #     self.mu_prior = mean
    #     # self.mu_prior_r = (self.mu_prior - self.centers)/self.model.tf +0.5001
    #     # self.sigma = sigma
    #     self.cov_prior = cov_prior
    #     self.norm = norm
    #     # self.cov_prior_r = ((self.sigma)/self.model.rf)**2 * tf.eye(self.Number_para, dtype=self.model.tfdtype) 
    ...
    def joint_log_post(self,mu,monitor=True):
        ...
        prior_log_prob_upper = self.mvn_prior_upper.log_prob(mu[self.Number_para:])
        ...
        joint_log = prior_log_prob_upper + prior_log_prob_lower + self.likelihood_log_prob
 
        if monitor == True:
            tf.print('prior_upper:',prior_log_prob_upper,'   prior_lower:',prior_log_prob_lower,'   likelihood:',self.likelihood_log_prob)
    ...
    def run_MCMC(self,method,
        ...
        if method == 'gpCN':
            ...
            self.time_hmc = end-start
            print('gpCN time in seconds: %.3f' % (self.time_hmc))
